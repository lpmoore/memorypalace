    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-4 border-t border-gray-700 bg-gray-800">
        ...
        <form onSubmit={handleAddItem} className="space-y-3">
          ...
          <button
            type="submit"
            disabled={!newItemDescription.trim() || !newItemAssociation.trim()}
            className="w-full py-2 px-4 bg-blue-600 hover:bg-blue-500 disabled:bg-gray-700 disabled:text-gray-500 text-white rounded-md transition-colors text-sm font-medium"
          >
            Add Item
          </button>
        </form>
